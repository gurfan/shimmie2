...
class CustomHomeTheme extends Themelet
{
...
<html lang="en">
	<head>
        ...
        <meta name="description" content="An image booru for all Space Station 13 content!">
		$hh
	</head>
	<body>
		$body
...
EOD
    ...
    public function build_body(string $sitename, string $main_links, string $main_text, string $contact_link, $num_comma, string $counter_text): string
    {
        ...
        return "
		<div id='front-page'>
			<h1><a style='text-decoration: none;' href='".make_link()."'><span><img src='/themes/ss13/static/clown.gif'></span></a></h1>
			$main_links_html
			$search_html
			$message_html
			$counter_html
