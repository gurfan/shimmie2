...
class ScreenshotListTheme extends Themelet
{
    ...
    protected function build_navigation(array $search_terms): string
    {
        ...
        $h_search_link = make_link("screenshots");
        $h_search = "
			<p><form action='$h_search_link' method='GET'>
				<input type='search' name='search' value='$h_search_string' placeholder='Search screenshot list' class='autocomplete_tags' autocomplete='off' />
